...
import {
    loadObjLightModelWithoutNormal,
    loadObjMirrorModelWithoutNormal,
    loadObjStaticModelWithoutNormal
} from "../load_obj_model.js";
...
let tallbox = loadObjMirrorModelWithoutNormal(renderer, await (await fetch("../models/cornellbox/tallbox.obj")).text());
// vec4.copy(tallbox.modelInfo.diffuse.buffer, [0.725, 0.71, 0.68, 1]);
vec4.copy(tallbox.modelInfo.mirror.buffer, [0.9, 0.9, 0.9, 0.002]);
